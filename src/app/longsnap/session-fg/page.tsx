    ...
    return (
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="text-center space-y-4 max-w-sm">
          ...
          <h2 className="text-xl font-bold text-slate-100">FG/PAT Snap Session</h2>
          <p className="text-sm text-muted">
            {sessionSnaps.length > 0 ? `${sessionSnaps.length} snap${sessionSnaps.length !== 1 ? "s" : ""} in progress.` : "Ready to log FG and PAT snaps."}
          </p>
          {!viewOnly ? (
