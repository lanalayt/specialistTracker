    ...
    <div className="flex-1 flex items-center justify-center p-8">
      <div className="space-y-6 w-full max-w-md">
        ...
        <div className="text-center">
          <h2 className="text-xl font-bold text-slate-100">Long Snap Session</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {isCoach && (
            <Link
              href="/athlete/longsnap/coaches-chart?type=long"
          ...
          <Link
            href="/athlete/longsnap/athlete-chart?type=long"
            className="card hover:bg-surface-2 hover:border-accent/30 transition-all group cursor-pointer flex flex-col items-center text-center py-8 px-4"
          >
